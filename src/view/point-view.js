...
import { getDuration, humanizePointDate, humanizePointTime } from '../util';
...
const createPointTemplate = ({point}) => {
  ...
  const duration = humanizePointTime(getDuration(dateFrom, dateTo));
  ...
  return (/* html */
    ...
    <div class="event">
      ...
      ${offers && offers.map(({ offerTitle, offerPrice }) => `
